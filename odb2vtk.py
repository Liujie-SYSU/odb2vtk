...
def ConvertOdb2Vtk(filename = 'C:\SIMULIA\User\odb2vtk.txt'):  #Modify the default value of filename here to specify the default configuration file
    ...
    print "ODB opened"
    # This is odb2vtk_code.py
    # It contains the actual code, identical for Function 1 and Function 2.
    # In each of Function1 and Function2, do: import odb2vtk_code (no extension) so that both Functions are in synch when changes are made. 
        ...
        for ins_i in input_instance:
            ...
            for i_frame in input_frame:
                ...
                for pn in range(piecenum):
                    ...
                    #Strain components E, <DataArray>, EJB: added this block
                    if EDataExists:
